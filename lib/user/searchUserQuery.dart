...
class searchUserQuery extends StatefulWidget {
  const searchUserQuery({super.key});

  @override
  State<searchUserQuery> createState() => _searchUserQueryState();
}

class _searchUserQueryState extends State<searchUserQuery> {
